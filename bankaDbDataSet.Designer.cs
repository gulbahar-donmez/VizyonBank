...
namespace VizyonBank.bankaDbDataSetTableAdapters {
...
SELECT MusteriID, Ad, Soyad, Email, Telefon, Adres, tcNO, Sifre, IBAN, Cinsiyet FROM Musteriler WHERE (MusteriID = @MusteriID)";
        ...
        public virtual int Fill(bankaDbDataSet.MusterilerDataTable dataTable) {
        ...
        public virtual bankaDbDataSet.MusterilerDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            bankaDbDataSet.MusterilerDataTable dataTable = new bankaDbDataSet.MusterilerDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(bankaDbDataSet.MusterilerDataTable dataTable) {
